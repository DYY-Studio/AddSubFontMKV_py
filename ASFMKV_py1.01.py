                ...
                if len(assfont.keys()) < 1:
                    ...
                    for s in assfont.keys():
                        ...
                        if not ssp[0] == ssp[1]:
                            ...
                            if errshow:
                                print('\033[1;32m[{3}]\033[0m \033[1;36m{0}\033[0m \033[1m<{1}>\033[1;31m{2}\033[0m'.format(assfont[s][1], 
                                path.basename(fn), ann, str(len(assfont[s][0])).rjust(maxnum)))
                            else: print('\033[1;32m[{3}]\033[0m \033[1;36m{0}\033[0m \033[1m<{1}>\033[1;32m{2}\033[0m'.format(assfont[s][1], 
                            path.basename(fn), ann, str(len(assfont[s][0])).rjust(maxnum)))
                            # print(assfont[s][0])
                        else:
                            if resultw:
