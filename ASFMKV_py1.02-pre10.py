...
将会返回以下
  newasspath: 新ass文件的绝对路径
    ...
    fullass.insert(infoline + 1, '; Subset via ASFMKV_py 1.02-Pre10 (with fontTools)\n')
                ...
                if len(assfont.keys()) < 1:
                    ...
                    for s in assfont.keys():
                        ...
                        if not ssp[0] == ssp[1]:
                            ...
                            print('\033[1;31m[{1}]\033[1;36m {0}\033[1;31m - No Found\033[0m'.format(ssp[0],
                                                                                                     'N'.center(maxnum,
                                                                                                                'N')))
...
def cLicense():
    cls()
    print('''AddSubFontMKV Python Remake 1.02 Preview10
Apache-2.0 License
...
def loadMain(reload: bool = False):
    ...
    os.system('title ASFMKV Python Remake 1.02-Pre10 ^| (c) 2022 yyfll ^| Apache-2.0')
    if not reload:
        if not o_fontload:
    ...
    if o_fontload:
        ...
        fltip = '包含乱码的名称'
    print('''ASFMKV Python Remake 1.02-Pre10 | (c) 2022 yyfll{0}
