...
class eventW(object):
    ...
    def pB_selectVO_Clicked():
        eventW.openDirDialog(ui.OvDir)

    def pB_selectSO_Clicked():
        eventW.openDirDialog(ui.OsDir)

    def pB_selectFO_Clicked():
        eventW.openDirDialog(ui.OfDir)

    def pB_selectV_Clicked():
        eventW.openDirDialog(ui.vPathL)

    def pB_selectS_Clicked():
        eventW.openDirDialog(ui.sPathL)

    def openDirDialog(text):
        dir = QFileDialog.getExistingDirectory(MW, '选择文件夹')
        text.setText(dir)
...
class Ui_MW(object):
    def setupUi(self, MW):
        ...
        self.pB_selectVO = QPushButton(self.outdir)
        self.pB_selectVO.setObjectName(u"pB_selectVO")
        self.pB_selectVO.setGeometry(QRect(510, 20, 31, 21))
        self.pB_selectSO = QPushButton(self.outdir)
        self.pB_selectSO.setObjectName(u"pB_selectSO")
        self.pB_selectSO.setGeometry(QRect(510, 40, 31, 21))
        self.pB_selectFO = QPushButton(self.outdir)
        self.pB_selectFO.setObjectName(u"pB_selectFO")
        self.pB_selectFO.setGeometry(QRect(510, 60, 31, 21))
        ...
        self.pB_selectS.setObjectName(u"pB_selectS")
        self.pB_selectS.setGeometry(QRect(720, 20, 51, 21))
        ...
        self.pB_selectV.setObjectName(u"pB_selectV")
        self.pB_selectV.setGeometry(QRect(720, 20, 51, 21))
        ...
        self.pB_selectFO.clicked.connect(eventW.pB_selectFO_Clicked)
        self.pB_selectS.clicked.connect(eventW.pB_selectS_Clicked)
        self.pB_selectSO.clicked.connect(eventW.pB_selectSO_Clicked)
        self.pB_selectV.clicked.connect(eventW.pB_selectV_Clicked)
        self.pB_selectVO.clicked.connect(eventW.pB_selectVO_Clicked)
    ...
    def retranslateUi(self, MW):
        ...
        self.pB_selectVO.setText(_translate("MW", "选择", None))
        self.pB_selectSO.setText(_translate("MW", "选择", None))
        self.pB_selectFO.setText(_translate("MW", "选择", None))
        ...
        self.pB_selectS.setText(_translate("MW", "选择", None))
        self.vPathG.setTitle(_translate("MW", "视频目录"))
        self.pB_selectV.setText(_translate("MW", "选择", None))
