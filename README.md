...
## 关于字体子集化的立场
注意到目前有字幕组选择了使用文件名与字体信息均无法还原的子集化字体
<br>我对此深表遗憾，并在此强调在ASFMKV Py并不会因此推出对应功能
<br>本脚本绝对不会对字体原有版权信息和字幕中字体还原信息进行抹杀
<br>我希望子集化是在尊重原有字体厂商的基础上所使用的，尽管这可能牵扯到版权问题
<br>一切让子集化字体完全脱离原字体的行为，本脚本都不会支持
