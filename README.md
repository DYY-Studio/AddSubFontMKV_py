...
## 目前已知问题
* 字体大小写不一致时可能无法匹配（Microsoft Yahei和Microsoft YaHei）
* 部分字体扫描出多余符号，或是只有几个字符（正在确认）
## 最新更新
### Py1.01
* 兼容`\fn`特效标签
* 兼容`\p`矢量绘图标签
...
| Code Geass | 漫友之家&异域动漫 简 | Format行与Dialogue间有空缺
| ちっちゃな雪使いシュガー | MYSUB 繁 | 矢量特效，Dialogue缺行
# 功能介绍
