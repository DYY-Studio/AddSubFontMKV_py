...
def assFontChange(fullass: list, newfont_name: dict, asspath: str, styleline: int, infoline: int,
    ...
    fullass.insert(infoline + 1, '; Subset via ASFMKV_py 1.02-Pre8\n')
...
def cLicense():
    cls()
    print('''AddSubFontMKV Python Remake 1.02 Preview8
Apache-2.0 License
...
def loadMain(reload: bool = False):
    ...
    os.system('title ASFMKV Python Remake 1.02-Pre8 ^| (c) 2022 yyfll ^| Apache-2.0')
    if not reload:
        if not o_fontload:
    ...
    print('''ASFMKV Python Remake 1.02-Pre8 | (c) 2022 yyfll{0}
