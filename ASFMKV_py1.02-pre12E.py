...
def cLicense():
    cls()
    print('''AddSubFontMKV Python Remake 1.02 Preview12
Apache-2.0 License
...
def loadMain(reload: bool = False):
    ...
    os.system('title ASFMKV Python Remake 1.02-Pre12E ^| (c) 2022 yyfll ^| Apache-2.0')
    if not reload:
        if not o_fontload:
    ...
    if o_fontload:
        ...
        fltip = '包含乱码的名称'
    print('''ASFMKV Python Remake 1.02-Pre12 | (c) 2022 yyfll{0}
